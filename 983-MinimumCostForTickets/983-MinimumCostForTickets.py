...
# len(days) = N
# Time: O(3*38*N) Need to get through each day option, checking 3 actions, checking (1+7+30) feasible next day option. 
# Space: O(N), as storing the results for N items
